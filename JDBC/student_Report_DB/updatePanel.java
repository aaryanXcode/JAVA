...
class updatePanel extends Panel  implements ActionListener
{
	...
	updatePanel(String roll,String phy,String chem,String math,String total,String per,String div)
	{
	...
	{	
		...
		if(obj==addStudent)
		{
			...
			//new studentInfo(RollNo,Physics,Chemistry,Maths,Total,Percentage,div).updateData();
			//System.out.println(newv.size());
			System.out.println(RollNo+" "+Physics+" "+Chemistry+" "+Maths+" "+Total+" "+Percentage+" "+div);
			new studentInfo().updateData(RollNo,Physics,Chemistry,Maths,Total,Percentage,div);
		}
		if(obj==deleteButton)
		{
			//newv.remove(index);
			//System.out.println(newv.size());
			new studentInfo().deleteData(Integer.parseInt(txRollNo.getText()));
